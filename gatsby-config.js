        ...
        feeds: [
          {
            serialize: ({ query: { site, allMarkdownRemark } }) => {
              return allMarkdownRemark.edges.map(edge => {
                ...
                const postText = `
                <div style="margin-top=55px; font-style: italic;">(This is an article posted to https://www.andromedastrength.com/. You can read it online by <a href="${siteUrl +
